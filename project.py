...
st.markdown("<h1 style='text-align: center; color: white;'>House Price Prediction Using AI</h1>", unsafe_allow_html=True)
...
menu = st.sidebar.radio("Menu", ["Home", "Dashboard","Prediction"و"About"])
if menu == "Home":
